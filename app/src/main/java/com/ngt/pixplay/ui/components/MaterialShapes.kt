...
fun RoundedPolygon.toShape(startAngle: Int = 0): Shape {
    ...
    return remember(this, startAngle) {
        object : Shape {
            // Store the Path we convert from the RoundedPolygon here.
            ...
            override fun createOutline(
                ...
                val finalPath = workPath!!
                finalPath.addPath(shapePath)
                ...
                finalPath.translate(size.center - finalPath.getBounds().center)
