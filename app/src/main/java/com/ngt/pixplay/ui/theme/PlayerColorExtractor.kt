...
object PlayerColorExtractor {
    ...
    /**
     * Extracts a single seed color from a bitmap for dynamic theme generation
     * 
     * @param bitmap The album art bitmap
     * @param fallbackColor Fallback color if extraction fails
     * @return The dominant vibrant color suitable for theme seeding
     */
    fun extractSeedColor(bitmap: android.graphics.Bitmap, fallbackColor: Color): Color {
